    ...
    <div className="flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="mt-6 text-xl text-gray-600 max-w-3xl">
                Blockpool simplifies the creation of Solana-based tokens with advanced features like transfer fees, staking rewards, and burn mechanisms.
              </p>
              <div className="mt-10 flex flex-wrap gap-4 justify-center lg:justify-start">
                <Button asChild size="lg" className="bg-gradient-to-r from-green-600 to-black hover:from-green-700 hover:to-gray-900 text-white">
            ...
            <div className="lg:w-1/2">
              <div className="relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-green-600 to-black rounded-lg blur opacity-75"></div>
                <div className="relative bg-white p-6 rounded-lg shadow-xl">
                  <div className="w-full h-64 bg-gray-100 rounded-md flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-green-600 to-black flex items-center justify-center">
      ...
      <section id="features" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold">Why Choose Blockpool?</h2>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <div className="bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-all border border-gray-100">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold">Who Benefits from Blockpool?</h2>
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="mt-12">
            <div className="flex flex-wrap border-b border-gray-200 mb-8">
              <button
                className={`px-6 py-3 text-lg font-medium ${activeTab === 'entrepreneurs' ? 'text-green-600 border-b-2 border-green-600' : 'text-gray-500'}`}
                onClick={() => setActiveTab('entrepreneurs')}
              >
                Entrepreneurs
              </button>
              <button
                className={`px-6 py-3 text-lg font-medium ${activeTab === 'developers' ? 'text-green-600 border-b-2 border-green-600' : 'text-gray-500'}`}
                onClick={() => setActiveTab('developers')}
              >
                Developers
              </button>
              <button
                className={`px-6 py-3 text-lg font-medium ${activeTab === 'businesses' ? 'text-green-600 border-b-2 border-green-600' : 'text-gray-500'}`}
